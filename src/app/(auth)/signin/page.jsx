...
//       <form onSubmit={form.handleSubmit(onSubmit)} className="w-96 bg-white p-6 rounded shadow">
//         <h2 className="text-2xl font-bold mb-4">Sign In</h2>

//         <div className="mb-4">
//           <label className="block">Email</label>
//           <input {...form.register("email")} className="w-full border p-2 rounded mt-1" />
//           <p className="text-sm text-red-500 mt-1">{form.formState.errors.email?.message}</p>
//         </div>

//         <div className="mb-4">
//           <label className="block">Password</label>
//           <input {...form.register("password")} type="password" className="w-full border p-2 rounded mt-1" />
...
//           Don't have an account? <a href="/auth/signup" className="text-sky-500">Sign up</a>
//         </div>
//       </form>
//     </div>
//   );
